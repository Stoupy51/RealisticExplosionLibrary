...
execute if data storage realistic_explosion:main {id:"minecraft:birch_shelf"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:{Name:"minecraft:birch_shelf"}}
...
execute if data storage realistic_explosion:main {id:"minecraft:copper_bars"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:{Name:"minecraft:copper_bars"}}
...
execute if data storage realistic_explosion:main {id:"minecraft:dried_ghast"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:{Name:"minecraft:dried_ghast"}}
...
execute if data storage realistic_explosion:main {id:"minecraft:leaf_litter"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:{Name:"minecraft:leaf_litter"}}
...
execute if data storage realistic_explosion:main {id:"minecraft:resin_block"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:{Name:"minecraft:resin_block"}}
execute if data storage realistic_explosion:main {id:"minecraft:resin_clump"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:{Name:"minecraft:resin_clump"}}
...
execute if data storage realistic_explosion:main {id:"minecraft:wildflowers"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:{Name:"minecraft:wildflowers"}}
